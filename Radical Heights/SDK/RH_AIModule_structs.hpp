...
#include "RH_GameplayTasks_classes.hpp"
...
struct FAIDynamicParam
{
	...
	TEnumAsByte<EAIParamType>                          ParamType;                                                // 0x0008(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
...
struct FEnvNamedValue
{
	...
	TEnumAsByte<EAIParamType>                          ParamType;                                                // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	float                                              Value;                                                    // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FEnvQueryInstanceCache
{
	...
	unsigned char                                      UnknownData00[0x1C8];                                     // 0x0008(0x01C8) MISSED OFFSET
};
...
struct FEnvBoolParam_DEPRECATED
{
	...
	struct FName                                       ParamName;                                                // 0x0008(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
};
