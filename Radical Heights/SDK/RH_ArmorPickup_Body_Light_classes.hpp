...
#include "RH_ArmorPickup_Body_Light_structs.hpp"
...
{
public:
	class USkeletalMeshComponent*                      Mesh;                                                     // 0x03F8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
