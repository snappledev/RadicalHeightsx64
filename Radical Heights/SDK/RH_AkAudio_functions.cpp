...
#include "RH_AkAudio_parameters.hpp"
...
void UAkGameplayStatics::STATIC_SetRTPCValue(const class FString& RTPC, float Value, int InterpolationTimeMs, class AActor* Actor)
{
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class FString                  LocCode                        (Parm, ZeroConstructor)
// class FString                  ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

class FString UAkGameplayStatics::STATIC_GetLanguageFromCode(const class FString& LocCode)
{
...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// class FString                  NewCulture                     (Parm, ZeroConstructor)

void UAkGameplayStatics::STATIC_ChangeAudioCulture(const class FString& NewCulture)
{
